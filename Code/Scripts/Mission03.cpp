...
DECLARE_SCRIPT(M03_Base_Harvester, "Tiberium_Loc:vector3, Dock_Location:vector3, Dock_Entrance:vector3, Sakura_Dest:vector3")
{
	...
	void Custom(GameObject * obj, int type, int param, GameObject * sender)
	{
		...
		{
			Commands->Set_Animation(obj, NULL, false, NULL, 0.0, -1.0f, false);
			ActionParamsStruct params;
		...
		{
			Commands->Set_Animation(obj, "V_NOD_HRVSTR.V_NOD_HRVSTR", true, NULL, 0.0, -1.0f, false);
			ActionParamsStruct params;
...
DECLARE_SCRIPT(M03_Chinook_ParaDrop, "Preset:string")
{
	...
	void Created(GameObject * obj)
	{
		...
		Commands->Set_Animation(chinook, "v_Nod_trnspt.XG_RTN_TrnsptA", true, NULL, 0.0, -1.0f, false);
