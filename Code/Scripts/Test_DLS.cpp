...
DECLARE_SCRIPT(M00_C130_ParaDrop, "Preset:string")
{
	...
	void Created(GameObject * obj)
	{
		...
		Commands->Set_Animation(chinook_rail, "X5D_Chinookfly.X5D_Chinookfly", false, NULL, 0.0, -1.0f, false);
		GameObject *chinook = Commands->Create_Object("Nod_Cargo_Plane", loc);
		Commands->Set_Facing(chinook, facing);
		Commands->Set_Animation(chinook, "vf_nod c-130.vf_nod c130", true, NULL, 0.0, -1.0f, false);
	...
	void Timer_Expired(GameObject * obj, int timer_id)
	{
		...
		case 1: 
			if (out >= 1)
			{
				...
				Commands->Set_Animation(para1, "X5D_Parachute.X5D_ParaC_1", false, NULL, 0.0, -1.0f, false);
		...
		case 2: 
			if (out >= 2)
			{
				...
				Commands->Set_Animation(para2, "X5D_Parachute.X5D_ParaC_2", false, NULL, 0.0, -1.0f, false);
		...
		case 3: 
			if (out == 3)
			{
				...
				Commands->Set_Animation(para3, "X5D_Parachute.X5D_ParaC_3", false, NULL, 0.0, -1.0f, false);
		...
		case 4: 
			...
			Commands->Set_Animation(box1, "X5D_Box01.X5D_Box01", false, NULL, 0.0, -1.0f, false);
			...
			Commands->Set_Animation(soldier1, "s_a_human.H_A_X5D_ParaT_1", false, NULL, 0.0, -1.0f, false);
			out++;
			if ((out - 1) == DIFFICULTY)
			{
				dead = true;
		...
		case 5: 
			...
			Commands->Set_Animation(box2, "X5D_Box02.X5D_Box02", false, NULL, 0.0, -1.0f, false);

			GameObject *soldier2;
			soldier2 = Commands->Create_Object_At_Bone(box2, preset, "Box02");
			Commands->Set_Facing(soldier2, facing);
			Commands->Set_Animation(soldier2, "s_a_human.H_A_X5D_ParaT_2", false, NULL, 0.0, -1.0f, false);
		...
		case 6: 
			...
			Commands->Set_Animation(box3, "X5D_Box03.X5D_Box03", false, NULL, 0.0, -1.0f, false);

			GameObject *soldier3;
			soldier3 = Commands->Create_Object_At_Bone(box3, preset, "Box03");
			Commands->Set_Facing(soldier3, facing);
			Commands->Set_Animation(soldier3, "s_a_human.H_A_X5D_ParaT_3", false, NULL, 0.0, -1.0f, false);
...
DECLARE_SCRIPT(DLS_SSM_Test, "")
{
	...
	{
		Commands->Set_Animation(obj, "V_NOD_SSM.V_NOD_SSM", 0, NULL, 0.0, -1.0f, false);
		Commands->Set_Animation(Commands->Find_Object(ssm_missile_id), "v_nod_ssm_Missl.v_nod_ssm_Missl", 0, NULL, 0.0, -1.0f, false);
	}
};
