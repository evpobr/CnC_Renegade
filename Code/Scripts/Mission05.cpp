...
DECLARE_SCRIPT(M05_Explode_Debris, "")
{
	...
	//	Commands->Action_Play_Animation(obj, params);
		Commands->Set_Animation(obj, "X5A_Debris.X5A_Debris_Boom", false, NULL, 0.0, -1.0f, false);
...
DECLARE_SCRIPT(M05_APC_Deploy, "Preset:string, Soldier_Qty=0:int, Fire_Gun=1:int")
{
	...
	{
		Commands->Set_Animation(obj, "V_NOD_APC.V_NOD_APC", 0, NULL, 0.0, -1.0f, false);
...
DECLARE_SCRIPT(M05_APC_Deploy_Soldier, "APC_ID=0:int")
{
	...
	void Created (GameObject * obj)
	{
		Commands->Set_Animation(obj, "S_A_Human.H_A_XG_NAPC_OUT", 0, NULL, 0.0, -1.0f, false);
		Commands->Enable_Hibernation (obj, false);		
	}
