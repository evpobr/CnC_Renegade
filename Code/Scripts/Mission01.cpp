...
DECLARE_SCRIPT(M01_HarvesterScript_New_JDG, "")
{
	...
	void Action_Complete (GameObject *obj, int action_id, ActionCompleteReason complete_reason)
	{
		...
		{
			animation_count = 0;
			Commands->Set_Animation(obj, "V_NOD_HRVSTR.V_NOD_HRVSTR", false, NULL, 0.0, -1.0f, false);
		}
	}
...
DECLARE_SCRIPT(M01_DetentionCiv_Air_Evac_Waypath_JDG, "")
{
	void Animation_Complete(GameObject * obj, const char *anim)
	{
		...
		{
			Commands->Set_Animation ( obj, "XG_TransprtBone.XG_EV1_Pathloop", true, NULL, 0.0, -1.0f, false );
		}
	...
	void Custom( GameObject * obj, int type, int param, GameObject * sender ) 
	{
		switch (param)
		{
			case M01_MODIFY_YOUR_ACTION_JDG: 
				{
					Commands->Set_Animation ( obj, "XG_TransprtBone.XG_EV1_PathZ", false, NULL, 0.0, -1.0f, false );
				}
				break;
		}
	}
...
DECLARE_SCRIPT(M01_DetentionCiv_Air_Evac_Chopper_JDG, "")
{
	...
	void Animation_Complete(GameObject * obj, const char *anim)
	{
		...
		{
			Commands->Set_Animation ( obj, "v_GDI_trnspt.XG_EV1_trnsloop", true, NULL, 0.0, -1.0f, false );
	...
	void Custom( GameObject * obj, int type, int param, GameObject * sender ) 
	{
		switch (param)
		{
			case M01_MODIFY_YOUR_ACTION_JDG: 
				{
					Commands->Set_Animation ( obj, "v_GDI_trnspt.XG_EV1_trnsz", false, NULL, 0.0, -1.0f, false );
				}
				break;
...
DECLARE_SCRIPT(M01_Church_EvacController_JDG, "")//103394 
{
	...
	void Custom( GameObject * obj, int type, int param, GameObject * sender ) 
	{
		...
		else if (param == M01_GIVE_ME_A_ROPE_JDG)//someone is waiting--pull him up
		{
			...
			if(troopbone)
			{
				Commands->Set_Animation ( troopbone, "XG_EV5_troopBN.XG_EV5_troopBN", false, NULL, 0.0, -1.0f, false);
			}
			else
			{
			...
			Commands->Set_Animation ( sender, "S_A_Human.XG_EV5_troop", false, NULL, 0.0, -1.0f, false );
		}
	}
			...
			case M01_MODIFY_YOUR_ACTION_JDG: 
				{
					...
					Commands->Set_Animation ( obj, "XG_EV5_rope.XG_EV5_ropeZ", false , NULL, 0.0, -1.0f, false);
				}
				break;
		}
	}
			...
			case M01_MODIFY_YOUR_ACTION_JDG: 
				{
					...
					Commands->Set_Animation ( obj, "XG_EV5_Path.XG_EV5_PathZ", false, NULL, 0.0, -1.0f, false );
				}
				break;
		}
	}
...
DECLARE_SCRIPT(M01_ChurchArea_Air_Evac_Chopper_JDG, "")
{
	void Created( GameObject * obj ) 
	{
		Commands->Set_Animation ( obj, "v_GDI_trnspt.XG_EV5_trnsA", false, NULL, 0.0, -1.0f, false );
	...
	void Animation_Complete(GameObject * obj, const char *anim)
	{
		if (stricmp(anim, "v_GDI_trnspt.XG_EV5_trnsA") == 0)
		{
			...
			Commands->Set_Animation ( obj, "v_GDI_trnspt.XG_EV5_trnsL", true, NULL, 0.0, -1.0f, false );
			...
			case M01_MODIFY_YOUR_ACTION_JDG: 
				{
					...
					Commands->Set_Animation ( obj, "v_GDI_trnspt.XG_EV5_trnsz", false, NULL, 0.0, -1.0f, false );
				}
				break;
