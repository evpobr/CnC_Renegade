...
DECLARE_SCRIPT(M06_Resistance_Raider_DLS, "")
{
	...
	void Created (GameObject * obj)
	{
		...
		Commands->Set_Animation(obj, "S_A_HUMAN.H_A_601A", true, NULL, 0.0, -1.0f, false);
			...
			case 2:
				{
					...
					Commands->Set_Animation(l6_fallfire01, "L6_Fallfire01.L6_Fallfire01", true, NULL, 0.0, -1.0f, false);
					...
					Commands->Set_Animation(l6_floorfire01, "L6_floorfire01.L6_floorfire01", true, NULL, 0.0, -1.0f, false);
				}
				break;
			...
			case 3:
				{
					...
					Commands->Set_Animation(l6_fallfire02, "L6_Fallfire02.L6_Fallfire02", true, NULL, 0.0, -1.0f, false);
					...
					Commands->Set_Animation(l6_floorfire02, "L6_floorfire02.L6_floorfire02", true, NULL, 0.0, -1.0f, false);					
			...
			case 6:
				{
					...
					Commands->Set_Animation(l6_fallfire03, "L6_Fallfire03.L6_Fallfire03", true, NULL, 0.0, -1.0f, false);
			...
			case 7:
				{
					...
					Commands->Set_Animation(l6_floorfire06, "L6_floorfire06.L6_floorfire06", true, NULL, 0.0, -1.0f, false);					
			...
			case 8:
				{
					...
					Commands->Set_Animation(l6_floorfire04, "L6_floorfire04.L6_floorfire04", true, NULL, 0.0, -1.0f, false);					
					...
					Commands->Set_Animation(l6_floorfire05, "L6_floorfire04.L6_floorfire05", true, NULL, 0.0, -1.0f, false);
					...
					Commands->Set_Animation(l6_fallfire05, "L6_Fallfire05.L6_Fallfire05", true, NULL, 0.0, -1.0f, false);
