...
DECLARE_SCRIPT(M00_C130_Dropoff_RMV, "ObjToCreate=:string")
{
	...
	{
		Commands->Set_Animation ( obj, "V_NOD_C-130E3.M_cargo-drop", 0, NULL, 0, -1, false );
		int drop_frame;
		drop_frame = 460;
		float drop_time;
...
DECLARE_SCRIPT(RMV_Transport_Evac, "Number:int, Nod=0:int")
{
	...
	void Created(GameObject * obj)
	{
		...
		Commands->Set_Animation(traj, traj_anim, false, NULL, 0, -1, false);
		Commands->Set_Animation(transport, trans_anim, false, NULL, 0, -1, false);
